...
cces <- cces %>% rename(recode_race_reg_wh_educ = recode_race_educ_reg) %>% 
    mutate(recode_race_educ_reg = as.factor(paste(recode_race, recode_region, 
                                                  recode_educ_3way , sep = ", ")))
#should maybe reduce to educ 3 way but let's just see how the margins look
unique(cces$recode_race_educ_reg)
...
#why are there NAs....not good
sum(is.na(weights(post_strat_reduc)[1:2052]))


weights_bmaxvar <- data.frame(kpop_w = weights_cat[[1]]$kpop_w[c(1:nrow(pew))],
                              kpop_demos_w = weights_cat[[1]]$kpop_contraint_w[c(1:nrow(pew))],
                              kpop_demos_edu_w = weights_cat[[1]]$kpop_contraint_weduc_w[c(1:nrow(pew))],
                              kpop_all_w = weights_cat[[1]]$kpop_full_constraint_w[c(1:nrow(pew))],
...
#colnames(sum_90perc) <- c("Kpop", "Kpop Demos", "Kpop Demos+Edu", "Kpop All")
sum_90perc
...
dist_w <- ggplot(weights_gg) + 
    ...
    theme_bw()
dist_w
ggsave(dist_w, file = "./plots/dist_w_close_y.pdf", height = 6, width = 10)


#### bias bound and L1

#for l1 and bias bound
# load(paste0("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/2016_Ex/allB_l1_cat_par_wTRUE_m500_t1e-06_2021-05-21.Rdata"))
# 
# load(paste0("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/2016_Ex/allB_l1_cat_par_wTRUE_m500_t1e-06_2021-05-21_2poss.Rdata"))

load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/2016_Ex/allB_update_l1_cat_par_wTRUE_m500_t1e-06_2021-05-22.Rdata")

#UGH this was run with trucated svds which messes up everything
...
# kpop_diag_r2
# out_cat_old <- out_cat
# rbind(out_cat_old, out_cat)
# t(out_cat_old)
# out_cat_old$bb_orig_constr/out_cat_old$bb_opt_constr
# out_cat_old$bb_orig_constr_weduc/out_cat_old$bb_opt_constr_weduc 
# 
# out_cat$bb_orig_demos/out_cat$bb_opt_demos
# out_cat$bb_orig_demos_weduc
# t(out_cat)
# 
# load(paste0(path_weights,"bmaxvar_cat_par_wTRUE_m500_t1e-06_2021-03-30.Rdata"))
# out_cat[, grepl( "bb_opt", colnames(out_cat))]
