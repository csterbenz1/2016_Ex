...
```{r cleaning_sims}
#load("/Users/Ciara/Dropbox/kpop/Updated/sims/cat_sims_wFALSE_m500_t1e-04_inc5mindims1402021-04-07_nsims500RData.RData")
load("/Users/Ciara/Dropbox/kpop/Updated/sims/cat_sims_modeled_outcomeFALSE_m500_t1e-04_inc5mindims1502021-06-19_nsims510.RData")
...
ggplot(data = plot_lasso_margin,
  ...
  theme_bw() +
  # ggtitle(paste0("Simu Results: lasso ",
...
ggsave(file = paste0("/Users/Ciara/Dropbox/kpop/Updated/sims/plots/cat_sims_b_maxvar_0619_modoutcome_slim.pdf"), height = 4, width = 6)
...
#for scale divide by mean(age) for target
# margins_total["agesq",] <- margins_total["agesq",]/margins_total["age","cces"]
# margins_total["agecubed",] <- margins_total["agecubed",]/margins_total["age","cces"]
...
wmabserr$var[wmabserr$var == "educ_wh_3way"]<- "educ(3way)_wh"
...
wmabserr_nooutcomes$var[wmabserr_nooutcomes$var == "educ_wh_3way"]<- "educ (3way)_wh"
...
```{r old_selection_lasso_outcome, eval = F}
##################### LASSO: Selection #############################
# Stack data with S = 1 indicating Pew
stack_data <- data.frame(bind_rows(pew, cces),
                         S = c(rep(1, nrow(pew)), rep(0, nrow(cces))))
