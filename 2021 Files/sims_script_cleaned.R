...
POPW = FALSE
cores_saved = 14
nsims = (detectCores()-cores_saved)*15 #20
nsims
eval_kpop = TRUE
...
###### updated here manually but need to update the lasso .rds soon 
...
save(sims,tolerance, maxit, increment, min_num_dims,
     file = paste0("./cat_sims_modeled_outcome",POPW, "_m",maxit, "_t",tolerance, "_inc",
...
#View(cbind(wmabserr[,1], round(wmabserr[,-1], 2)))
