...
#THIS IS THE KABLE IN TEH APPENDIX!
kable(t(t(conf_cces_test$table)/colSums(conf_cces_test$table))*100, 
      format = "latex", booktabs = T, digits = 3, caption = "Confusion Matrix: CCES on CCES (Testing Data)\n")

```


```{r save_dat_lasso, eval = F}
############# Add to data
...
saveRDS(cces, file = "cces_lasso_061021.rds")
saveRDS(pew, file = "pew_lasso_061021.rds")
