...
#### THIS IS THE FINAL VERSION THAT WAS USED TO PRODUCE res_kpopTRUE_noise1_on2023-10-04_nsims1000.RData
#on the ISI cluster; run in serires in the end bc parallel bogs down memory usage
