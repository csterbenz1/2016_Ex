...
#to save memory also to prevent model.matrix from dropping rows unncess bc other cols are msissing
...
pew_out <- function(PRE = TRUE,
    ...
    if(!is.null(xgb_cces_mod)) {
         if(three_way) {
            ...
            ######## PRED ON PEW #######
            ### 1. CCES ON PEW
            mod_cces_on_pew = predict(xgb_cces_mod, pew_matrix_all, reshape=T)
            ...
            if(three_way) {
                ...
                mod_cces_on_pew_out <- case_when(mod_cces_on_pew_plur-1 == 1 ~  "Republican",
                                         mod_cces_on_pew_plur-1 == 0 ~ "Democrat")
            }
            ...
            if(three_way) {
                ...
                mod_pew_on_pew_out <- factor(case_when(mod_pew_on_pew_plur-1 == 1 ~  "Republican",
                                               mod_pew_on_pew_plur-1 == 0 ~ "Democrat"),
                                     levels = c("Democrat", "Republican"))
            }
            ...
            if(three_way) {
                ...
                mod_pew_on_cces_out <- case_when(mod_pew_on_cces_plur-1 == 1 ~
                                                     "Republican",
                                         mod_pew_on_cces_plur-1 == 0 ~ "Democrat")
            }
            ...
            ### CCES ON CCES
            mod_cces_on_cces = predict(xgb_cces_mod, cces_matrix_all, reshape=T)
            ...
            if(three_way) {
               mod_cces_on_cces_out <- factor(case_when(mod_cces_on_cces_plur-1 == 2 ~ 
                 ...
                 mod_cces_on_cces_out <- case_when(mod_cces_on_cces_plur-1 == 1 ~  "Republican",
                                              mod_cces_on_cces_plur-1 == 0 ~ "Democrat")
            }
            ...
            if(three_way) {
                ...
                #prob rep
                mod_cces_on_pew_pR <- mod_cces_on_pew[,2]
                mod_pew_on_pew_pR <- mod_pew_on_pew[,2]
            ...
            if(three_way) {
                ...
                #prob rep
                mod_cces_on_cces_pR <- mod_cces_on_cces[,2]
                mod_pew_on_cces_pR <- mod_pew_on_cces[,2]
            ...
            cces_xgb <- cbind(cces, 
                              ...
                              diff_pew_on_cces)
            if(three_way) {
                cces_xgb <- cbind(cces_xgb, mod_cces_on_cces_pO, mod_pew_on_cces_pO)
            }
    } else if(!is.null(lasso_cces_mod)) {
        warning("drop_NAs must be true with lasso model", .immediate = T)
        cces <- cces %>% filter(!is.na(recode_vote_2016))
        ...
        if(!three_way) {
          ...
          ##### Pew model
            ...
            ######### Predict on PEW
            lasso_cces_on_pew = predict(lasso_cces_mod,
                      s = lasso_lambda_cces$lambda.1se,
                      type = "response",
                      newx = mod[stack_data$S==1,-1])
            ...
            ##### Predict on CCES
            lasso_cces_on_cces = predict(lasso_cces_mod,
                      s = lasso_lambda_cces$lambda.1se,
                      type = "response",
            ...
            ############### Model Performance
            #1. cces on pew
            mod_cces_on_pew_out <- case_when(lasso_cces_on_pew > .5 ~  "Republican",
                                             TRUE ~ "Democrat")
            ...
            ### 2. PEW ON PEW
            mod_pew_on_pew_out <- case_when(lasso_pew_on_pew > .5 ~  "Republican",
                                             TRUE ~ "Democrat")
            sum(mod_pew_on_pew_out == pew$recode_vote_2016)/nrow(pew)
            conf_pew_pew <- confusionMatrix(mod_pew_on_pew_out, 
                                            as.factor(pew$recode_vote_2016))
            ...
            ####### PRED ON CCES ######
            ### 3. PEW on CCES
            mod_pew_on_cces_out <- case_when(lasso_pew_on_cces > .5 ~  "Republican",
                                             TRUE ~ "Democrat")
            
            outcome <- cces$recode_vote_2016
            #got rid of this in the lasso case
            #outcome[is.na(outcome)] <- "Other"
            sum(mod_pew_on_cces_out == outcome)/length(outcome)
            conf_pew_on_cces <- confusionMatrix(as.factor(mod_pew_on_cces_out),
                                                as.factor(outcome))
            ...
            #### 4. CCES ON CCES
            mod_cces_on_cces_out <- case_when(lasso_cces_on_cces > .5 ~  "Republican",
                                             TRUE ~ "Democrat")
            sum(mod_cces_on_cces_out == outcome)/length(outcome)
            conf_cces_on_cces <- confusionMatrix(as.factor(mod_cces_on_cces_out),
                                                 as.factor(outcome))
            ...
            cces_xgb <- cces %>%
              mutate(mod_cces_on_cces_pD = 1- lasso_cces_on_cces, 
                     mod_cces_on_cces_pR = lasso_cces_on_cces, 
                     mod_pew_on_cces_pD = 1- lasso_pew_on_cces,
                     mod_pew_on_cces_pR = lasso_pew_on_cces) %>% 
            ...
            pew_xgb <- pew %>%
              mutate(mod_cces_on_pew_pD = 1- lasso_cces_on_pew, 
                     mod_cces_on_pew_pR = lasso_cces_on_pew, 
                     mod_pew_on_pew_pD = 1- lasso_pew_on_pew,
                     mod_pew_on_pew_pR = lasso_pew_on_pew) %>% 
            ...
            ###################### LASSO ####################
            #### pew model 
            lasso_lambda_pew <- cv.glmnet(x= mod[stack_data$S == 1,-1], 
                                      y = pew$recode_vote_2016,
                                      alpha = 1,
                                      family = "multinomial",
                                      intercept = TRUE)
            
            lasso_vote_pew <- glmnet(x= mod[stack_data$S == 1, -1], 
                                 y = pew$recode_vote_2016,
                                    alpha = 1,
                                    lambda = lasso_lambda_pew$lambda.1se,
                                    family = "multinomial",
        ...
        stop("missing classification model")
    }
    ...
    if(noDNK_weights) {
        ...
        if(popw) {
            ...
            targets_ps_all <- svytable(formula = ~strata_all,
                               design = subset(cces_awt_xgb, !(strata_all %in%
                                                                missing_strata_all)))
            if(cat_kernel & NEWpopw) {
                load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_NEWwTRUE_m500_t1e-06_2021-03-09.Rdata")
                cat("OLD MF loading: allB_cat_par_NEWwTRUE_m500_t1e-06_2021-03-09.Rdata")
                clean <- out_cat
                ...
                if(tolerance == 1e-06 & maxit == 500) { 
                         load("/Users/Ciara/Dropbox/kpop/Updated/application/weights/allB_cat_par_wTRUE_m500_t1e-06_2021-03-18.Rdata")
                ...
                if(maxit == 800 & tolerance == 1e-04) {
                     load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_wTRUE_m800_t1e-04_2021-03-23.Rdata")
            ...
            if(cat_kernel) {
                ...
                } else if(maxit == 500 & tolerance == 1e-04) {
                    load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_m500_t1e-04_2021-03-05.Rdata")
                    cat("OLD MF loading: allB_cat_par_m500_t1e-04_2021-03-05.Rdata")
        ...
        stop("w DNK voters has not been rerun with updates")
    }
        ...
        df <- df %>% 
            mutate(source_name = factor(source, 
                                        ...
                                        labels = c("CCES Orig",
                                                   ...
                                                   if(cat_kernel) {"Kpop b=argmax var K*2"},
                                            if(cat_kernel) {"Kpop Conv b=argmax var(K)*2"},
                                            if(cat_kernel) {"Kpop MF b=argmax var(K)*2"},
    ...
    comp_df_diff <- df_build("recode_vote_2016", "diff_cces_on_cces", "diff_cces_on_pew",
                             ...
                             cat_kernel = cat_kernel)
    #comp_df_diff <- comp_df_diff %>% arrange(!is.na(b), b)
    ...
    comp_df_diff_pewoutcome <- df_build("recode_vote_2016", 
                                        ...
                                        bigB = bigB, smallB = smallB,
                                        cat_kernel = cat_kernel) 
    #comp_df_diff_pewoutcome <- comp_df_diff_pewoutcome %>% arrange(!is.na(b), b)
...
###### XXX do I want to have diff with cces_on_pew as well for cces_xgb or as below just use cces_on_ccess for cces_xgb for both
    comp_df_margin <- df_build("recode_vote_2016", 
                               ...
                               bigB = bigB,  smallB = smallB,
                               cat_kernel = cat_kernel)  
    #comp_df_margin <- comp_df_margin %>% arrange(!is.na(b), b)
    ...
    comp_df_margin_pewoutcome <- df_build("recode_vote_2016", 
                                          ...
                                          bigB = bigB,
                                           smallB = smallB,
                                          cat_kernel = cat_kernel)  
    #comp_df_margin_pewoutcome <- comp_df_margin_pewoutcome %>% arrange(!is.na(b), b)
    ...
    comp_df_pR <- comp_df_pR  %>% arrange(!is.na(b), b)
    ...
    comp_df_pR_pewoutcome <- df_build("recode_vote_2016", 
                           ...
                           cat_kernel = cat_kernel, 
                           vote_form = quote((recode_vote_2016Republican  +recode_vote_2016Republican)/2 )) 
    #comp_df_pR_pewoutcome <- comp_df_pR_pewoutcome %>% arrange(!is.na(b), b)
    ...
    #comp_df_pD <- comp_df_pD  %>% arrange(!is.na(b), b)
    ...
    comp_df_pD_pewoutcome <- df_build("recode_vote_2016", 
                           ...
                           bigB = bigB, smallB = smallB,
                           cat_kernel = cat_kernel)  
    #comp_df_pD_pewoutcome <- comp_df_pD_pewoutcome %>%arrange(!is.na(b), b)
    ...
    comp_df_real <- df_build("recode_vote_2016", 
                           ...
                           bigB = bigB,
                            smallB = smallB,
                           cat_kernel = cat_kernel)  %>% arrange(!is.na(b), b)
    #comp_df_real <- comp_df_real%>% arrange(!is.na(b), b)
    ...
    comp_df_real_diff <-  df_build("recode_vote_2016", 
                           ...
                           real = TRUE, bigB = bigB, 
                            smallB = smallB,
                           cat_kernel = cat_kernel) 
    #comp_df_real_diff <- comp_df_real_diff %>% arrange(!is.na(b), b)
    ...
    comp_df_plot_real_diff <-
        ...
        ggtitle(paste(pew_ver, " Pew on TRUE CCES Vote Difference\n",  NAs_lab,
                      popw_lab, ageb, dnk, tol_label, maxit_label)) +
        theme(axis.text.x = element_text(angle = 70, hjust = 1,
                                         face=if(PRE) {
    ...
    comp_df_plot_diff <-
        ...
        labs(x = NULL, y = "Reweighted Estimate of Predicted Retrospective Vote Difference (95% CI)") +
        ...
        annotate(geom = "text", 
                 x =if(display_pew_mod) {nrow(comp_df_pR_merge)+0.85} else{nrow(comp_df_pR)+.85}, 
        ...
        #          hjust = 0, angle = 90, size = 3) +
        annotate(geom = "text", 
                 x = if(display_pew_mod) {nrow(comp_df_pR_merge)+.85} else{nrow(comp_df_pR)+.85}, 
        ...
        #for spacing
        annotate(geom = "text", 
                 x = if(display_pew_mod) {nrow(comp_df_pR_merge)+2.85} else{nrow(comp_df_pR)+2.85},
                 y = comp_df_diff$est[comp_df_diff$source_name == "CCES Modeled"],
                 label = "",
                 color = "purple",
                 hjust = 0, angle = -90, size = 3) +
    ...
    comp_df_plot_both_pR <-
       ...
       # geom_pointrange(data = comp_df_pR_pewoutcome, alpha = 0.4) +
        ...
        ggtitle(paste(pew_ver,"Pew on CCES", mod_lab,  "p(R)", out_lab,"modeled\n",
                      popw_lab, ageb, dnk, tol_label, maxit_label)) +
        theme(axis.text.x = element_text(angle = 70, hjust = 1,
                                         face=if(PRE& smallB) {
    ...
    comp_df_plot_both_pD <-
        ...
        labs(x = NULL, y = "Estimated Modeled Vote p(R) (95% CI)") +
        ggtitle(paste(pew_ver, "Pew on CCES", mod_lab, "p(D)", out_lab,"modeled\n",
                      popw_lab, ageb, dnk, tol_label, maxit_label)) +
        theme(axis.text.x = element_text(angle = 70, hjust = 1,
                                         face=if(PRE& smallB) {
...
stack_data_train <- data.frame(bind_rows(pew %>% 
                                             dplyr::select(recode_female,
                                                    recode_pid_3way,
                                                    recode_educ,
                                                     recode_region,
                                                     recode_income_5way, 
...
#this doesnt work bc it drops rows that are missing on some of the other cols not in C_model which is stupid
...
nrow(cces)
lasso_pvote_3way = predict(lasso_cces,
                      s= lasso_lambda$lambda.1se,
                      type = "response",
...
# drop_ccesNAs = TRUE
# xgb_cces_mod = NULL
# lasso_cces_mod = lasso_cces
# lasso_lambda_cces = lasso_lambda
# bigB = TRUE
# smallB = TRUE
# cat_kernel  = TRUE
...
cat_kernel_NOpopw <- pew_out(PRE = TRUE,
                           age_buckets = FALSE, 
                           popw = FALSE,
                           three_way = TRUE,
                           drop_ccesNAs = TRUE, 
...
cat_kernel_NOpopw$plot_real_diff
...
cat_kernel_NOpopw$plot_real_margin
...
cat_kernel_NOpopw_neg4 <- pew_out(PRE = TRUE,
                           age_buckets = FALSE, 
                           popw = FALSE,
                           three_way = TRUE,
                           drop_ccesNAs = TRUE, 
...
cat_kernel_NOpopw_neg4$plot_diff
ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/votediff_t1e-04_m500_allb.pdf", width = 14, height = 8)


#ok so these are like identical
#they are only difference on the pre-wave pew which is becuase we reruan the xgb model in between
#somewhat concerning that rerunning the model produces 1% chance differences
#I should probably do lots of xgb ccess runs and see how much variance we get...and whether the weights appropriately weight een as teh target adn variable moves around XXXXX
compare_tolerance <- data.frame(source = cat_kernel_NOpopw_neg4$comp_df_diff$source, 
                                outcome = cat_kernel_NOpopw_neg4$comp_df_diff$model,
                                neg6 = cat_kernel_NOpopw$comp_df_diff$est, 
                                neg4 =  cat_kernel_NOpopw_neg4$comp_df_diff$est) %>% mutate(diff = neg6 - neg4)

View(compare_tolerance)
...
### WITH POP WEIGHTS
#Old method (weight U)
cat_kernel_popw <- pew_out(PRE = TRUE,
                           age_buckets = FALSE, 
                           popw = TRUE,
                           three_way = TRUE,
                           drop_ccesNAs = TRUE, 
...
#ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/POPW_votediff_t1e-06_m500_allb.pdf", width = 14, height = 8)
...
#New method (weight K)
cat_kernel_NEWpopw <- pew_out(PRE = TRUE,
                           age_buckets = FALSE, 
                           popw = TRUE,
                           three_way = TRUE,
                           drop_ccesNAs = TRUE, 
...
cat_kernel_NEWpopw$plot_real_diff
cat_kernel_NEWpopw$plot_diff
ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/NEWPOPW_votediff_t1e-06_m500_allb.pdf", width = 14, height = 8)
cat_kernel_NEWpopw$plot_real_margin
cat_kernel_NEWpopw$plot_margin
cat_kernel_NEWpopw$plot_pR
cat_kernel_NEWpopw$plot_pD


compare_weighting<- data.frame(source = cat_kernel_popw$comp_df_diff$source, 
                                outcome = cat_kernel_popw$comp_df_diff$model,
                                oldW = cat_kernel_popw$comp_df_diff$est, 
                                newW =  cat_kernel_NEWpopw$comp_df_diff$est) %>% mutate(diff = oldW - newW)

View(compare_weighting)



######################## Runs on popw + lasso
cat_kernel_popw_lasso <- pew_out(PRE = TRUE,
                           age_buckets = FALSE, 
                           popw = TRUE,
                           three_way = TRUE,
                           drop_ccesNAs = TRUE, 
...
cat_kernel_popw_lasso$plot_diff
ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/lasso_popw_votediff_t1e-06_m500_allb_8x5.pdf", width = 8, height = 5)
cat_kernel_popw_lasso$plot_pR
cat_kernel_popw_lasso$plot_pD
View(cat_kernel_popw_lasso$comp_df_diff)
View(cat_kernel_popw_lasso$comp_df_pD)
cat_kernel_popw_lasso$comp_df_pR[2, "est"] - cat_kernel_popw_lasso$comp_df_pR[26, "est"]
cat_kernel_popw_lasso$comp_df_pD[2, "est"] - cat_kernel_popw_lasso$comp_df_pD[26, "est"]
# cat_kernel_NEWpopw_lasso <- pew_out(PRE = TRUE,
#                            age_buckets = FALSE, 
#                            popw = TRUE,
#                            three_way = TRUE,
#                            drop_ccesNAs = TRUE, 
...
#                       display_pew_mod = FALSE)
# 
# cat_kernel_NEWpopw_lasso$plot_diff
...
allmargins <- function(pop_weights = FALSE,
    ...
    if(cat_kernel) {
        ...
        if(pop_weights & !NEWpopw & maxit == 500 & tolerance == 1e-06) {
            # load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_wTRUE_m500_t1e-06_2021-03-18.Rdata")
            #load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_wTRUE_m500_t1e-06_2021-03-18_OLD.Rdata")
            # load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_wTRUE_m500_t1e-06_2021-03-18.Rdata")
            load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/bmaxvar_cat_par_wTRUE_m500_t1e-06_2021-03-30.Rdata")
            index = 1
            cat("loading: bmaxvar_cat_par_wTRUE_m500_t1e-06_2021-03-30 \n")
            #load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_wTRUE_m500_t1e-06_2021-03-05.Rdata")
        ...
        } else if(pop_weights & NEWpopw & maxit == 500 & tolerance == 1e-06) {
            
            load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_NEWwTRUE_m500_t1e-06_2021-03-09.Rdata") 
            cat("loading: allB_cat_par_NEWwTRUE_m500_t1e-06_2021-03-09 \n")
            
        } else if(!pop_weights & tolerance == 1e-06 & maxit == 500) {
            
            # load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_m500_t1e-06_2021-03-04.Rdata")
            # cat("OLD MF loading:allB_cat_par_m500_t1e-06_2021-03-04 \n")
            load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/bmaxvar_cat_par_wFALSE_m500_t1e-06_2021-03-30.Rdata")
            index = 1
            cat("loading: bmaxvar_cat_par_wFALSE_m500_t1e-06_2021-03-30 \n")
            
            
        } else if(!pop_weights & tolerance == 1e-04 & maxit == 500) {
            
            load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_m500_t1e-04_2021-03-05.Rdata")
            cat("OLD MF loading:allB_cat_par_m500_t1e-04_2021-03-05\n")
        ...
        kpop_constr_w <- weights_cat[[index]]$kpop_contraint_w
        kpop_constr_wedu_w <- weights_cat[[index]]$kpop_contraint_weduc_w
        kpop_full_constr_w <- weights_cat[[index]]$kpop_full_constraint
        ...
        # colnames_bottom = c("Variable", "Orig", "", "+Conv", "(All)", "(Demos)", "(All)", "All", "Reduc", "All", "Retro")
        colnames_bottom = c("Variable", "Orig", "","(Demos)", "(Demos)",
                            "(Demos+Edu)", "(Demos+Edu)", "(All)",  "(All)",
                             "Retro", "Reduc")
        if(!full_constr) {
            colnames_bottom = colnames_bottom[-5]
        }
        ...
        kpop_mf_w <- weights_nodnk_noNAs_nopopw[[index]]$kpop_mf_w
            ...
            if(drop_ccesNAs) {
                ...
                kpop_full_conv_w <- weights_nodnk_nopopw[[index]]$kpop_w_conv_full
    ...
    if(cat_kernel) {
         ...
         kpop_constr_weud <-  svydesign(~1, data = pew_xgb_dat,
                              weights = kpop_constr_wedu_w[kbal_data_sampled ==1])
    ...
    if(is.null(margins_formula)) {
        if(three_way) {
         ...
         margins_formula <- ~recode_vote_2016 +
                mod_cces_on_pew_pD + mod_cces_on_pew_pR + 
                mod_pew_on_pew_pD + mod_pew_on_pew_pR + 
                recode_pid_3way + 
                recode_female + recode_race +recode_region + recode_educ +recode_relig_6way+
                recode_born + recode_attndch_4way + recode_income_5way +
                recode_age_bucket+recode_age+recode_agesq+recode_agecubed+recode_age_factor+
          ...
          margins_formula_cces <- ~recode_vote_2016 +
            mod_cces_on_cces_pD + mod_cces_on_cces_pR + 
            mod_pew_on_cces_pD + mod_pew_on_cces_pR + 
            recode_pid_3way + 
            recode_female + recode_race +recode_region + recode_educ + recode_relig_6way + 
            recode_born + recode_attndch_4way + recode_income_5way +
            recode_age_bucket + recode_age +recode_agesq+recode_agecubed+recode_age_factor +
    ...
    margins <- round(cbind(
        ...
        kpop_constr_wedu = if(cat_kernel) {
            svymean(margins_formula, kpop_constr_weud)
            }else {NA},
    ...
    margins_diff <- as.data.frame(margins) %>% 
        mutate(pew = cces_margins - pew,
              ...
              kpop_constr_wedu = if(cat_kernel) {cces_margins - kpop_constr_wedu }
               else {NA},
    ...
    group_by(var) %>% summarize(pew_unweighted = mean(abs(pew)), 
                                ...
                                kpop_constr_wedu = mean(abs(kpop_constr_wedu)),
    ...
    if(drop_ccesNAs) {
        ...
        NAs_lab = " XXX CCES NAs "
    }
    tol_label = paste0(" tol=",as.character(tolerance))
    maxit_label = paste0( " maxit=", as.character(maxit))
    
    
    if(!cat_kernel & pop_weights) {
        caption_m = paste0("Margins (Difference): ",NAs_lab, popw_lab, ageb, " (no dnk) ",
                       "b=", round(b, 2), xgb_lab)
        caption_o = paste0("Absolute Error on Margins of Outcomes: ",
        ...
        caption_m = paste0("Margins (Difference): Unscaled K ", "b=", round(b, 2),NAs_lab, popw_lab, " Age Buckets Only (no dnk) ",
                       xgb_lab, tol_label, maxit_label)
        caption_o = paste0("Absolute Error on Margins of Outcomes: Unscaled K ","b=", round(b, 2),
                       NAs_lab, popw_lab, " Age Buckets Only (no dnk) ",
                        xgb_lab, tol_label, maxit_label)
    
        caption_err = paste0("Weighted Mean Abs Error: Unscaled K ","b=", round(b, 2), NAs_lab, popw_lab,
                              " Age Buckets Only (no dnk) ",xgb_lab, tol_label, maxit_label)
    } else {
        caption_m = paste0("Margins (Difference): Former K ", "b=", round(b, 2),NAs_lab, popw_lab, " Age Buckets Only (no dnk) ",
                       xgb_lab, tol_label, maxit_label)
        caption_o = paste0("Absolute Error on Margins of Outcomes: Unscaled K ","b=", round(b, 2),
                       NAs_lab, popw_lab, " Age Buckets Only (no dnk) ",
                        xgb_lab, tol_label, maxit_label)
    
        caption_err = paste0("Weighted Mean Abs Error: Former K ","b=", round(b, 2), NAs_lab, popw_lab,
                              " Age Buckets Only (no dnk) ",xgb_lab, tol_label, maxit_label)
    }
    ...
    if(!cat_kernel) {
        ...
        formula_kpop_weduc <- c("female", "race",
                      "region", "pid_3way","educ_6way", 
                       "age_buckets")
        ...
        formula_kpop_weduc <- c("female", "race",
                      "region", "pid_3way","educ_6way", 
                       "age_buckets")
         formula_kpop_all <- c("female", "race",
                      "region", "pid_3way","educ_6way", "age_buckets",
                      "income_5way", "relig_6way","born","attndch_4way")
    ...
    if(cat_kernel) { 
        ...
        kpop_constr_wedu_aes <- ifelse((wmabserr_nooutcomes$var %in% formula_kpop_weduc), "gray", "black")
        kpop_full_constr_aes <- ifelse((wmabserr_nooutcomes$var %in% formula_kpop_all), "gray", "black")
    ...
    if(!full_constr) {
        pass <- wmabserr[, -which(colnames(wmabserr) == "kpop_full_constr")]
    } else {
        pass <- wmabserr
    }
    kable_om <- kable(pass %>% 
                       ...
                       format = "latex",
                       caption = caption_o, 
                       col.names = colnames_bottom,#c("Variable", colnames_bottom[-2]),
                       booktabs = T,
                       digits = 3)
    ...
    if(!full_constr) {
        pass <-margins_out[, -which(colnames(margins_out) == "kpop_full_constr")]
    } else {
        pass <- margins_out
    }
    
    kable_margins <- kable(pass,
          format = "latex",
          caption = caption_m,
          col.names = colnames_bottom,
          booktabs = T, digits= 3) 
...
cat_margins_popw <- allmargins(pop_weights = TRUE, 
                               NEWpopw = FALSE,
                             age_buckets = FALSE, 
                             three_way = TRUE, 
                             b = b_run[2],
                             pew_xgb_dat = cat_kernel_popw_lasso$pew_dat,
                             cces_xgb_dat = cat_kernel_popw_lasso$cces_dat, 
                             drop_ccesNAs = TRUE, 
                             tolerance = 1e-06,
                             maxit = 500,
                              cat_kernel = TRUE, 
...
cat_margins_NEWpopw <- allmargins(pop_weights = TRUE, 
                                  NEWpopw = TRUE,
                                  three_way = TRUE, 
                             age_buckets = FALSE, 
                             b = b_run[2],
                             pew_xgb_dat = cat_kernel_popw$pew_dat,
                             cces_xgb_dat = cat_kernel_popw$cces_dat, 
                             drop_ccesNAs = TRUE, 
                              cat_kernel = TRUE)
View(cat_margins_NEWpopw$wmabserr)
cat_margins_NEWpopw$kable_err
cat_margins_NEWpopw$kable_outmom

# 
# compare_margins <- data.frame(var = rbind(cat_margins_popw$wmabserr$var,
#                                           cat_margins_NEWpopw$wmabserr$var),
#                              kpop =   rbind(cat_margins_popw$wmabserr$kpop,
#                                           cat_margins_NEWpopw$wmabserr$kpop),
#                              kpop_conv =  rbind(cat_margins_popw$wmabserr$kpop_conv,
#                                           cat_margins_NEWpopw$wmabserr$kpop_conv), 
#                              kpop_mf =  rbind(cat_margins_popw$wmabserr$kpop_mf,
#                                           cat_margins_NEWpopw$wmabserr$Kpop_mf),
#                              weight = c(rep("wU", nrow(cat_margins_popw$wmabserr)), 
#                                         rep("wK", nrow(cat_margins_popw$wmabserr))) )

compare_margins <- data.frame(var = as.character(cat_margins_popw$wmabserr$var),
                             kpop_wU =  cat_margins_popw$wmabserr$kpop,
                             kpop_wK =  cat_margins_NEWpopw$wmabserr$kpop,
                             kpop_conv_wU = cat_margins_popw$wmabserr$kpop_conv,
                             kpop_conv_wK = cat_margins_NEWpopw$wmabserr$kpop_conv, 
                             kpop_mf_wU = cat_margins_popw$wmabserr$kpop_mf,
                             kpop_mf_wK = cat_margins_NEWpopw$wmabserr$kpop_mf) %>%
    mutate(diff_kpop = abs(kpop_wU - kpop_wK),
           diff_kpop_conv = abs(kpop_conv_wU - kpop_conv_wK),
           diff_kpop_mf = abs(kpop_mf_wU - kpop_mf_wK))

View(compare_margins %>% select(var, diff_kpop, diff_kpop_conv, diff_kpop_mf))
# 
# 
# 
# 
# kpop_w_age <- (kpop_w[kbal_data_sampled ==1]*pew_xgb_dat$recode_agße)
# 
...
load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_m500_t1e-06_2021-03-04.Rdata")
#load("../allB_cat_par_wTRUE_m800_t1e-04_2021-03-23.Rdata")


biasbound <- rbind(out_cat %>% dplyr::select(b, bbr, bbr_conv, bbr_mf, bbr_constr, bbr_full_constr, numdims, numdims_conv, numdims_mf, numdims_constr, numdims_full_constr, mf_append_dims)) %>% arrange(b)

biasbound <- rbind(out_cat %>% dplyr::select(b, bbr, bbr_conv, bbr_mf, bbr_constr, numdims, numdims_conv, numdims_mf, numdims_constr )) %>% arrange(b)
...
biasbound %>% filter(max(bbr_full_constr) == bbr_full_constr) %>% dplyr::select(b)
kable(biasbound,
       format = "latex",
       caption = "Unscaled Kernel + No Pop W: Bias Bound (Orig:Optimal) and Dims Selected; Tol = 1e=-06 Maxit = 500", 
       booktabs = T,
       digits = 3)
```
...
#using 80% to train
percent <- sample.int(n = nrow(cces_DR),
                      size = round((nrow(cces_DR)/10)*8) )
