    ...
    if(noDNK_weights) {
        ...
        if(popw) {
            ...
            if(cat_kernel) {
                ...
                if(tolerance == 1e-06) {
                    load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_par_m500_t1e-06_2021-03-18.Rdata")
                } else if(tolerance == 1e-04) {
...
ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/lassosimple_MFnomc_popw_votediff_t1e-06_m500_allb.pdf", width = 14, height = 8)
...
allmargins <- function(pop_weights = FALSE,
    ...
    if(!cat_kernel) {
        ...
        caption_o = paste0("Absolute Error on Margins of Outcomes and First Moments: Unscaled K ","b=", round(b, 2),
...
kable(biasbound,
       format = "latex",
       caption = "Unscaled Kernel + POPW (Weighted U): Bias Bound (Orig:Optimal) and Dims Selected", 
       booktabs = T,
       digits = 3)
```
