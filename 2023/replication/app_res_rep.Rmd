...
main_res_plot <- function(target = "modeled vote choice",
    ...
    ####### adding new SEs to vote diff outcome  XXXXX
...
#re-run to get kable with ps(all) included for appendix
...
#comparing differeint SE estimators
...
```{r K_scree, eval = F}
############# K Scree plots
#loads the full Kbal results, including the svd(K) object which is large
load("/Users/Ciara_1/Dropbox/kpop/2023/application/weights/DEBUG_full_kbal_obj_2023-04-06.Rdata")

#make Kernels with different b values and take SVD
#OR, load from .Rdata since this takes some time
load("/Users/Ciara_1/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/2016_Ex/Kscree_svds.Rdata")
#NB: the factof of sqrt(1/2) is included because the onehot data has doubled counts everywhere which needs to be "undone" either in the denominator b, or in the data itself
#in other words:
