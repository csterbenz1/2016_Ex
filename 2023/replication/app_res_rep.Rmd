...
NB: can use manually generated data from data_prep_rep.R which should be named "cces_prepared.rds" and "pew_prepared.rds." Below uses the original prepared data "cces_prepared_orig.rds" and "pe_prepared_orig.rds" used by the authors.
    ...
    if(eval_margins) { 
        ...
        if(is.null(margins_var_order)) {
            margins_var_order = c("female", "pid_3way", "age_bucket","race",  "region", "educ_6way",
                      ...
                      "midwest_edu_race", "race_reg_wh_educ")
        }
        #reorder rows
...
The following loads the svd of several kernel matrices to save time. They can easily be directly reproduced using the code below, it is just time consuming to compute.
...
load("/Users/Ciara_1/Dropbox/kpop/2023/application/weights/Kscree_svds.Rdata")
