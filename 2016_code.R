...
#load("mf_F_wPid_varyb.Rdata")
#load("mf_T_wPid_varyb.Rdata")
# numdims_wPid <- data.frame(numdims_mf_F_wPid = c(kbal_b.125x$numdims, 
#                                          kbal_b.25x$numdims,
#                                          kbal_b.5x$numdims,
#                                          kbal_b1x$numdims,
#                                          kbal_b2x$numdims),
#                            numdims_mf_T_wPid = c(kbal_mf_b.125x$numdims, 
#                                          kbal_mf_b.25x$numdims,
#                                          kbal_mf_b.5x$numdims,
#                                          kbal_mf_b1x$numdims,
#                                          kbal_mf_b2x$numdims),
#                            mfdims_mf_T_wPid = c(kbal_mf_b.125x$meanfirst.dims, 
#                                                  kbal_mf_b.25x$meanfirst.dims,
#                                                  kbal_mf_b.5x$meanfirst.dims,
#                                                  kbal_mf_b1x$meanfirst.dims,
#                                                  kbal_mf_b2x$meanfirst.dims))
...
#                               "b=2x")
# save(numdims_wPid,
#      file = "numdims_wPid_varyb.Rdata")
# load("mf_F_NoPid_varyb.Rdata")
# load("mf_T_NoPid_varyb.Rdata")
#  
# numdims_NoPid <- data.frame(numdims_mf_F_NoPid = c(kbalout_nopid_b.0625x$numdims,
#                                                    kbalout_nopid_b.125x$numdims,
#                                                    kbalout_nopid_b.25x$numdims,
#                                                    kbalout_nopid_b.5x$numdims,
#                                                    kbalout_nopid_b1x$numdims,
#                                                    kbalout_nopid_b2x$numdims),
#                            numdims_mf_T_NoPid = c(NA,
#                                                   kbalout_mf_nopid_b.125x$numdims,
#                                                  kbalout_mf_nopid_b.25x$numdims,
#                                                  kbalout_mf_nopid_b.5x$numdims,
#                                                  kbalout_mf_nopid_b1x$numdims,
#                                                  kbalout_mf_nopid_b2x$numdims),
#                            mfdims_mf_T_NoPid = c(NA,
#                                                  kbalout_mf_nopid_b.125x$meanfirst.dims,
#                                                 kbalout_mf_nopid_b.25x$meanfirst.dims,
#                                                 kbalout_mf_nopid_b.5x$meanfirst.dims,
#                                                 kbalout_mf_nopid_b1x$meanfirst.dims,
#                                                 kbalout_mf_nopid_b2x$meanfirst.dims))
...
#                             "b=2x")
# save(numdims_NoPid,
#      file = "numdims_NoPid_varyb.Rdata")
...
# kbal_mf_b2x <- kbal(allx=kbal_data,
...
# 
# ### KPOP + MF=T + PID + b = 1
# kbal_mf_b1x <- kbal(allx=kbal_data,
#                     sampled = kbal_data_sampled,
#                     b = 1 * ncol(kbal_data),
#                     incrementby = 1,
#             population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
# 
# ### KPOP + MF=T + PID + b = .5
# kbal_mf_b.5x <- kbal(allx=kbal_data,
#                     sampled = kbal_data_sampled,
...
### KPOP + MF=T + PID + b = .25 
# kbal_mf_b.25x <- kbal(allx=kbal_data,
#                     sampled = kbal_data_sampled,
...
### KPOP + MF=T + PID + b = .125
# kbal_mf_b.125x <- kbal(allx=kbal_data,
#                     sampled = kbal_data_sampled,
...
# kbalout_nopid_b.25x <- kbal(allx=kbal_data_nopid,
#                       sampled = kbal_data_sampled,
...
# kbalout_nopid_b.5x <- kbal(allx=kbal_data_nopid,
#                            sampled = kbal_data_sampled,
...
# kbalout_nopid_b.125x <- kbal(allx=kbal_data_nopid,
#                              sampled = kbal_data_sampled,
...
# kbalout_nopid_b.0625x <- kbal(allx=kbal_data_nopid,
#                               sampled = kbal_data_sampled,
...
# kbalout_nopid_b1x <- kbal(allx=kbal_data_nopid,
#                               sampled = kbal_data_sampled,
...
# kbalout_nopid_b2x <- kbal(allx=kbal_data_nopid,
#                           sampled = kbal_data_sampled,
...
#                           sampledinpop = FALSE)
# 
# save(kbalout_nopid_b1x,kbalout_nopid_b2x, file = "mfF_NoPID_varyb.Rdata")


############ KPOP + MF=TRUE + NO PID +  Conv

#these runs stored in: mf_T_NoPid_varyb.Rdata
#### (1) Kbal + NO PID + MF = TRUE + b=0.125x  + Conv
# kbalout_mf_nopid_b.125x <- kbal(allx=kbal_data_nopid,
#                          sampled = kbal_data_sampled,
#                          b = 0.125 * ncol(kbal_data_nopid),
#                          meanfirst = TRUE,
#            population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
#### (2) Kbal + NO PID + MF = TRUE + b=0.25x  + Conv
# kbalout_mf_nopid_ <- kbal(allx=kbal_data_nopid,
#                          sampled = kbal_data_sampled,
#                          b = 0.25 * ncol(kbal_data_nopid),
#                          meanfirst = TRUE,
#            population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
# kbalout_mf_nopid_b.5x <- kbal(allx=kbal_data_nopid,
#                          sampled = kbal_data_sampled,
#                          b = 0.5 * ncol(kbal_data_nopid),
#                          meanfirst = TRUE,
#            population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
#### (4) Kbal + NO PID + MF = TRUE + b=1x  + Conv
# kbalout_mf_nopid_b1x <- kbal(allx=kbal_data_nopid,
#                          sampled = kbal_data_sampled,
#                          b = 1 * ncol(kbal_data_nopid),
#                          meanfirst = TRUE,
#            population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
#### (5) Kbal + NO PID + MF = TRUE + b=2x  + Conv
# kbalout_mf_nopid_b2x <- kbal(allx=kbal_data_nopid,
#                          sampled = kbal_data_sampled,
#                          b = 2 * ncol(kbal_data_nopid),
#                          meanfirst = TRUE,
#            population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
# kbalout_mf_nopid_b.25x <- kbal(allx=kbal_data_nopid,
#                              sampled = kbal_data_sampled,
#                              b = 0.25 * ncol(kbal_data_nopid),
#                              meanfirst = TRUE,
#             population.w = cces$commonweight_vv_post / mean(cces$commonweight_vv_post),
...
# ##### (1) Kbal + MF = FALSE + PID
# bb_comp <- data.frame(biasbound_orig = c(kbal_b2x$biasbound.orig,
#                                          kbal_b1x$biasbound.orig,
#                                          kbal_b.5x$biasbound.orig,
#                                          kbal_b.25x$biasbound.orig,
#                                          kbal_b.125x$biasbound.orig),
#                              biasbound_opt = c(kbal_b2x$biasbound.opt,
#                                                kbal_b1x$biasbound.opt,
#                                                kbal_b.5x$biasbound.opt,
#                                                kbal_b.25x$biasbound.opt,
#                                                kbal_b.125x$biasbound.opt),
#                              L1_orig = c(kbal_b2x$L1.orig,
#                                          kbal_b1x$L1.orig,
#                                          kbal_b.5x$L1.orig,
#                                          kbal_b.25x$L1.orig,
#                                          kbal_b.125x$L1.orig),
#                              L1_opt = c(kbal_b2x$L1.opt,
#                                          kbal_b1x$L1.opt,
#                                          kbal_b.5x$L1.opt,
#                                          kbal_b.25x$L1.opt,
#                                          kbal_b.125x$L1.opt)
...
##### (2) Kbal + MF = TRUE + PID 
# bb_comp_mf <- data.frame(biasbound_orig = c(kbal_mf_b2x$biasbound.orig,
#                                             kbal_mf_b1x$biasbound.orig,
#                                             kbal_mf_b.5x$biasbound.orig,
#                                             kbal_mf_b.25x$biasbound.orig,
#                                             kbal_mf_b.125x$biasbound.orig),
#                       biasbound_opt = c(kbal_mf_b2x$biasbound.opt,
#                                         kbal_mf_b1x$biasbound.opt,
#                                         kbal_mf_b.5x$biasbound.opt,
#                                         kbal_mf_b.25x$biasbound.opt,
#                                         kbal_mf_b.125x$biasbound.opt),
#                       L1_orig = c(kbal_mf_b2x$L1.orig,
#                                   kbal_mf_b1x$L1.orig,
#                                   kbal_mf_b.5x$L1.orig,
#                                   kbal_mf_b.25x$L1.orig,
#                                   kbal_mf_b.125x$L1.orig),
#                       L1_opt = c(kbal_mf_b2x$L1.opt,
#                                  kbal_mf_b1x$L1.opt,
#                                  kbal_mf_b.5x$L1.opt,
#                                  kbal_mf_b.25x$L1.opt,
#                                  kbal_mf_b.125x$L1.opt)
#                       )
# 
...
# bb_comp_nopid <- data.frame(biasbound_orig = c(kbalout_nopid_b2x$biasbound.orig,
#                                                kbalout_nopid_b1x$biasbound.orig,
#                                                kbalout_nopid_b.5x$biasbound.orig,
#                                                kbalout_nopid_b.25x$biasbound.orig,
#                                                kbalout_nopid_b.125x$biasbound.orig,
#                                                kbalout_nopid_b.0625x$biasbound.orig),
#                             biasbound_opt = c(kbalout_nopid_b2x$biasbound.opt,
#                                               kbalout_nopid_b1x$biasbound.opt,
#                                               kbalout_nopid_b.5x$biasbound.opt,
#                                               kbalout_nopid_b.25x$biasbound.opt,
#                                               kbalout_nopid_b.125x$biasbound.opt,
#                                               kbalout_nopid_b.0625x$biasbound.opt),
#                             L1_orig = c(kbalout_nopid_b2x$L1.orig,
#                                         kbalout_nopid_b1x$L1.orig,
#                                         kbalout_nopid_b.5x$L1.orig,
#                                         kbalout_nopid_b.25x$L1.orig,
#                                         kbalout_nopid_b.125x$L1.orig,
#                                         kbalout_nopid_b.0625x$L1.orig),
#                             L1_opt = c(kbalout_nopid_b2x$L1.opt,
#                                        kbalout_nopid_b1x$L1.opt,
#                                        kbalout_nopid_b.5x$L1.opt,
#                                        kbalout_nopid_b.25x$L1.opt,
#                                        kbalout_nopid_b.125x$L1.opt,
...
# bb_comp_mf_nopid <- data.frame(biasbound_orig = c(kbalout_mf_nopid_b2x$biasbound.orig,
#                                                   kbalout_mf_nopid_b1x$biasbound.orig,
#                                                   kbalout_mf_nopid_b.5x$biasbound.orig,
#                                                   kbalout_mf_nopid_b.25x$biasbound.orig,
#                                                   kbalout_mf_nopid_b.125x$biasbound.orig),
#                             biasbound_opt = c(kbalout_mf_nopid_b2x$biasbound.opt,
#                                               kbalout_mf_nopid_b1x$biasbound.opt,
#                                               kbalout_mf_nopid_b.5x$biasbound.opt,
#                                               kbalout_mf_nopid_b.25x$biasbound.opt,
#                                               kbalout_mf_nopid_b.125x$biasbound.opt),
#                             L1_orig = c(kbalout_mf_nopid_b2x$L1.orig,
#                                         kbalout_mf_nopid_b1x$L1.orig,
#                                         kbalout_mf_nopid_b.5x$L1.orig,
#                                         kbalout_mf_nopid_b.25x$L1.orig,
#                                         kbalout_mf_nopid_b.125x$L1.orig),
#                             L1_opt = c(kbalout_mf_nopid_b2x$L1.opt,
#                                        kbalout_mf_nopid_b1x$L1.opt,
#                                        kbalout_mf_nopid_b.5x$L1.opt,
#                                        kbalout_mf_nopid_b.25x$L1.opt,
#                                        kbalout_mf_nopid_b.125x$L1.opt)
#                             )
# 
...
#save(bb_comp_nopid, bb_comp_mf_nopid, bb_comp, bb_comp_mf, file = "bb_dat.Rdata")
...
#                          weights = kbal_b2x$w[kbal_data_sampled ==1])
# kbal_wt_b1x <- svydesign(~1, data = pew,
#                          weights = kbal_b1x$w[kbal_data_sampled ==1])
# kbal_wt_b.5x <- svydesign(~1, data = pew,
#                           weights = kbal_b.5x$w[kbal_data_sampled ==1])
# kbal_wt_b.25x <- svydesign(~1, data = pew,
#                            weights = kbal_b.25x$w[kbal_data_sampled ==1])
# kbal_wt_b.125x <- svydesign(~1, data = pew,
#                             weights = kbal_b.125x$w[kbal_data_sampled ==1])
# 
# ## (1.2) KPOP + MF = TRUE + W PID
# kbal_mf_wt_b2x <- svydesign(~1, data = pew,
#                          weights = kbal_mf_b2x$w[kbal_data_sampled ==1])
# kbal_mf_wt_b1x <- svydesign(~1, data = pew,
#                          weights = kbal_mf_b1x$w[kbal_data_sampled ==1])
# kbal_mf_wt_b.5x <- svydesign(~1, data = pew,
#                           weights = kbal_mf_b.5x$w[kbal_data_sampled ==1])
# kbal_mf_wt_b.25x <- svydesign(~1, data = pew,
#                            weights = kbal_mf_b.25x$w[kbal_data_sampled ==1])
# kbal_mf_wt_b.125x <- svydesign(~1, data = pew,
#                             weights = kbal_mf_b.125x$w[kbal_data_sampled ==1])
# 
...
#      kbal_mf_wt_b.125x,
#      file = "surveys_wPID.Rdata")

#### (2) Survey Desings from NO PID runs
## (2.1) KPOP + MF = FALSE + NO PID
# kbal_wt_b2x_nopid <- svydesign(~1, data = pew, 
#                                 weights = kbalout_nopid_b2x$w[kbal_data_sampled ==1])
# kbal_wt_b1x_nopid <- svydesign(~1, data = pew, 
#                                 weights = kbalout_nopid_b1x$w[kbal_data_sampled ==1])
# kbal_wt_b.5x_nopid <- svydesign(~1, data = pew, 
#                                 weights = kbalout_nopid_b.5x$w[kbal_data_sampled ==1])
# kbal_wt_b.25x_nopid <- svydesign(~1, data = pew, 
#                                  weights = kbalout_nopid_b.25x$w[kbal_data_sampled ==1])
# kbal_wt_b.125x_nopid <- svydesign(~1, data = pew, 
#                                 weights = kbalout_nopid_b.125x$w[kbal_data_sampled ==1])
...
#                             weights = kbalout_mf_nopid_b2x$w[kbal_data_sampled ==1])
# kbal_wt_mf_nopid_b1x <- svydesign(~1, data = pew, 
#                             weights = kbalout_mf_nopid_b1x$w[kbal_data_sampled ==1])
# kbal_wt_mf_nopid_b.5x <- svydesign(~1, data = pew, 
#                             weights = kbalout_mf_nopid_b.5x$w[kbal_data_sampled ==1])
# kbal_wt_mf_nopid_b.25x <- svydesign(~1, data = pew, 
#                             weights = kbalout_mf_nopid_b.25x$w[kbal_data_sampled ==1])
# kbal_wt_mf_nopid_b.125x <- svydesign(~1, data = pew, 
#                             weights = kbalout_mf_nopid_b.125x$w[kbal_data_sampled ==1])
...
#save(wts_NoPid, file = "weights_NoPid.Rdata")
#sapply(wts, summary)
#sapply(wts, sd)
