...
if(pop_weighted_avg) {
    w_margins_diff <- margins_diff*(margins_total[, "cces"]/100)
    #dont's square cces:
...
ggsave(file = paste0("/Users/Ciara/Dropbox/kpop/Updated/application/plots/cat_sims_b_maxvar_4-07_dat_slim.pdf"), height = 4, width = 6)
