...
library(parallel)
#latest version:
#3devtools::install_github("csterbenz1/KBAL", ref = "cat_kernel") 
library(kbal)
library(glmnet)

#set appropriate path for cces and pew data files
path_data= "/Users/Ciara_1/Dropbox/kpop/Updated/application/data/" 

#Parameters to controll details of kbal() run
tolerance = 1e-6
maxit = 500
increment = 1
min_num_dims = 1
...
#rescale CCES weights to sum to N
cces <- cces%>% 
...
#outcome is projected cces modeled vote difference
#(modeled vote difference pD - pR = vote choice using lasso and projected back on to pew and ccess)
#file: /Users/Ciara_1/Dropbox/kpop/Updated/application/app_model_outcome.Rmd
...
kbal_demos_est <- kbal(K.svd = svdK,
                       ...
                       sampledinpop = FALSE)
#save estimates and diagonostics
...
######################## Compile results of all Kpop runs
out = list()
