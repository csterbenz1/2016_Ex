...
pew_out <- function(PRE = TRUE,
    ...
    if(!is.null(xgb_cces_mod)) {
        ...
        C_model = as.formula(~recode_female:recode_pid_3way + 
                              ...
                              recode_race:recode_region:recode_educ_wh_3way:recode_pid_3way + 
                                 ...
                                 recode_income_5way + recode_relig_6way + recode_born + 
                                 recode_attndch_4way +
                              recode_age +
                              I(recode_age^2))
...
#ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/lasso_popw_votediff_t1e-06_m500_allb.pdf", width = 14, height = 8)
...
kable(biasbound,
       format = "latex",
       caption = "Unscaled Kernel + New POPW (Weighted K): Bias Bound (Orig:Optimal) and Dims Selected", 
       booktabs = T,
       digits = 3)
```
