...
#ggsave("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/Working/current plots/app_cat_vdiff_allb.pdf", width = 14, height = 8)
...
allmargins <- function(pop_weights = FALSE, 
    ...
    if(cat_kernel) {
        ...
        kpop_mf_w <- weights_nodnk_noNAs_nopopw[[index]]$kpop_mf_w
            ...
            cces_svy <- cces_nowt
            b_lab = paste0("b", b, "x")
             colnames_bottom = c("No Wts", "No Wts", b_lab, b_lab, b_lab,"all", 
                                    "reduc", "all", "retro")
    ...
    kable_margins <- kable(margins_out,
          format = "latex",
          caption = caption_m,
...
```{r run_specific}
load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_parallel2021-02-26.Rdata")
b_run <- out_cat$b
...
#bigger tolerance: NO DIFFERENCE....
load("/Users/Ciara/Documents/Cloud Documents/Hazlett:Hartman RA/2016 Election/allB_cat_parallel_2021-02-26.Rdata")

biasbound_old <- rbind(out_cat %>% dplyr::select(b, bbr, bbr_conv, bbr_mf, numdims, numdims_conv, numdims_mf, mf_append_dims)) %>% arrange(b)
