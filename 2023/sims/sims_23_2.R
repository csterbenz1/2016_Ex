...
nsims = (detectCores()-cores_saved)*24
nsims = 1000
...
# check_sample(survey_sim, selection_model)
#check_sample_outcome(survey_sim, cces,selection_model, inter,inter_2)
...
coefs_outcome[1] = 15 #for up_nonlin = 1
#coefs_outcome[1] = 17 #
cor(p_include, cces_expanded %*% coefs_outcome)
if(!bern) {
